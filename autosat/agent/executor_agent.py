...
class ExecutorAgent(CommonAgent):
    """Execution agent, designed to solve a task with LLM.

    ExecutorAgent is a subclass of CommonAgent configured with a default system message.
